<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Tên người dùng">
        <template slot-scope="scope">
    ...
    <el-dialog title="Sửa người dùng" :visible.sync="dialogFormVisible">
      <el-form
        ref="dataForm"
        :model="user"
        label-position="left"
      ...
      >
        ...
        <!-- <b-form-select v-model="user.status" class="mb-3" label="Trạng thái">
